...
if __name__ == "__main__":
    ...
    print('To dmp combined covid positive cohorts:', 'df.shape:', df.shape)
    df.to_csv('matrix_cohorts_covid_4manuNegNoCovidV2age18_boolbase-nout-withAllDays-withPreg_recover_covid_positive.csv')

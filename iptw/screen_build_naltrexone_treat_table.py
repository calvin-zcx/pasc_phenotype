...
def build_exposure_group_and_table1_less_4_print(exptype='all', debug=False):
    ...
    out_file = r'./naltrexone_output/Table-naltrexone-{}-25Q3.xlsx'.format(exptype)
...
if __name__ == '__main__':
    ...
    # 2025-07-15
    df, df_out = build_exposure_group_and_table1_less_4_print(exptype='naltrexone-acuteIncident-0-30', debug=False)  # 'ssri-base180-acutevsnot'

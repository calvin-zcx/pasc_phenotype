...
if __name__ == "__main__":
    ...
    # 2024-11-14 exclude edema as sensitivity
    print ('further exclude edema from outcome as a sensitivity analysis')
    _exclude_list += ['Other general signs and symptoms', ]
    ...
    for i, pasc in tqdm(enumerate(selected_screen_list, start=1), total=len(selected_screen_list)):
        ...
        out_file_balance = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/{}-{}-results.csv'.format(
            args.usedx,
            args.kmatch,
            args.useacute,
            args.severity,
        ...
        df_summary.to_csv(
            '../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/{}-{}-evaluation_balance.csv'.format(
                args.usedx,
                args.kmatch,
                args.useacute,
                args.severity,
        ...
        dfps.to_csv(
            '../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/{}-{}-evaluation_ps-iptw.csv'.format(
                args.usedx,
                args.kmatch,
                args.useacute,
                args.severity,
                i, pasc.replace(':', '-').replace('/', '-')))
        try:
            figout = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/{}-{}-PS.png'.format(
                args.usedx,
                args.kmatch,
                args.useacute,
                args.severity,
        ...
        km, km_w, cox, cox_w, cif, cif_w = weighted_KM_HR(
            ...
            fig_outfile=r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/{}-{}-km.png'.format(
                args.usedx,
                args.kmatch,
                args.useacute,
                args.severity,
        ...
        try:
            ...
            if i % 5 == 0:
                pd.DataFrame(causal_results, columns=results_columns_name). \
                    to_csv(
                    r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/causal_effects_specific-snapshot-{}.csv'.format(
                        args.usedx,
                        args.kmatch,
                        args.useacute,
                        args.severity,
            ...
            df_causal.to_csv(
                r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/causal_effects_specific-ERRORSAVE.csv'.format(
                    args.usedx,
    ...
    df_causal.to_csv(
        r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx{}k{}useacute{}-V3-{}-NoEdema/causal_effects_specific.csv'.format(
            args.usedx,
            args.kmatch, args.useacute, args.severity, ))

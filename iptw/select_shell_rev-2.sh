...
taskset --cpu-list 4-7 python screen_dx_vtrim_downsample.py --dataset V15_COVID19 --site ALL --severity all 2>&1 | tee  log/screen_dx_insight_ALL_all_Vtrim_downsample.txt

...
def load_pasc_info():
    ...
    pasc_simname['any_pasc'] = ('PASC', 'Any PASC')  # ('Long COVID', 'Any PASC')
    ...
    # add n3c
    pasc_simname['CP PASC-N3C'] = ('PASC (N3C)', 'Any PASC')  #('Long COVID (N3C)', 'Any PASC')
...
def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV2_reorder(show='full'):
    ...
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV2-reorder.pdf'.format(show), bbox_inches='tight',
                transparent=True)
...
def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV2_reorderV2(show='full'):
    indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    output_dir = indir + r'figure_2cohorts/'
    df_1 = pd.read_csv(indir + 'causal_effects_specific.csv')
    df_1.drop_duplicates(subset=['pasc'], keep='last', inplace=True, )
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV2-reorderV2-namerevise.png'.format(show),
                bbox_inches='tight', dpi=600)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV2-reorderV2-namerevise.pdf'.format(show),
...
def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3(show='full'):
    indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    output_dir = indir + r'figure_2cohorts/'
    df_1 = pd.read_csv(indir + 'causal_effects_specific.csv')
    df_1.drop_duplicates(subset=['pasc'], keep='last', inplace=True, )
    ...
    # load n3c results, should edit to our format
    # df_2 = pd.read_csv(r'../data/recover/output/pregnancy_output/N3C/24_07_21 Publication N3C Results-selected_4fig1.csv')
    df_2 = pd.read_csv(r'../data/recover/output/pregnancy_output/N3C/24_08_05 Updated Site N3C Results_4fig1.csv')
    ...
    organ_mapname = {
        'Any PASC': 'PCORNet-Primary',  #'Primary-PCORNet',
        'Death': 'Overall',
        'Hospitalization': 'Overall',
        'Diseases of the Nervous System': 'Neurologic',
        'Diseases of the Skin and Subcutaneous Tissue': 'Skin',
        ...
        'Any PASC (N3C)': 'N3C-Primary',  #'Primary-N3C',
        'General (N3C)': 'Secondary-General (N3C)',
        'Any CFR (N3C)': 'Secondary-CFR (N3C)',
        'cognitive-fatigue-respiratory (N3C)': 'CFR Individuals (N3C)',
    }
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV4.png'.format(show), bbox_inches='tight', dpi=600)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV4.pdf'.format(show), bbox_inches='tight', transparent=True)

    print('Done')
    return df_result


def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV2_reorderV2_sensitivity(show='full'):
    indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    output_dir = indir + r'figure_2cohorts/'
    df_1 = pd.read_csv(indir + 'causal_effects_specific.csv')
    df_1.drop_duplicates(subset=['pasc'], keep='last', inplace=True, )
    ...
    pasc_simname_organ = load_pasc_info()
    pasc_simname_organ['PASC-General'] = ('U099/B948', 'Unspecified PASC')
    # pasc_simname_organ['any_CFR'] = ('Any CFR (PCORnet)', 'Any CFR')
    # pasc_simname_organ['Cognitive'] = ('Cognitive (PCORnet)', 'cognitive-fatigue-respiratory')
    # pasc_simname_organ['Fatigue'] = ('Fatigue (PCORnet)', 'cognitive-fatigue-respiratory')
    # pasc_simname_organ['Respiratory'] = ('Respiratory (PCORnet)', 'cognitive-fatigue-respiratory')

    pasc_simname_organ['U09/B94-N3C'] = ('U099/B948 (N3C)', 'Unspecified PASC')

    pasc_simname_organ['CP PASC-N3C'] = ('Long COVID (N3C)', 'Any PASC (N3C)')

    pasc_simname_organ['Cognitive-N3C'] = ('Cognitive (N3C)', 'cognitive-fatigue-respiratory')
    pasc_simname_organ['Fatigue-N3C'] = ('Fatigue (N3C)', 'cognitive-fatigue-respiratory')
    pasc_simname_organ['Respiratory-N3C'] = ('Respiratory (N3C)', 'cognitive-fatigue-respiratory')

    pasc_simname_organ['Any_secondary-N3C'] = ('Any CFR (N3C)', 'Any CFR')
    ...
    df_1 = df_1.sort_values(by='PASC Name Simple', ascending=True)
    df_select = pd.concat([df_1, df_2], ignore_index=True, sort=False)
    df_select = df_select.sort_values(by='PASC Name Simple', ascending=True)
    ...
    organ_mapname = {
        ...
        # 'Certain Infectious and Parasitic Diseases',
        'General': 'General',
        'Unspecified PASC': 'Unspecified PASC',
        # 'General-add',
        # 'brainfog':'Brain Fog',
        # 'Any CFR': 'Secondary-CFR',
        'Any CFR': 'Cognitive/Fatigue/Respiratory (CFR)',
    ...
    axs = fp.forestplot(
        ...
        group_order=df_result['group'].unique(),
        xlabel="Hazard Ratio",  # x-label title
        xticks=[0.1, 1, 1.5],  # x-ticks to be printed
        color_alt_rows=True,
        # flush=True,
        sort=False,  #True,  # sort estimates in ascending order
        # sortby='-aHR',
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV2-reorderV2-sensitivity.png'.format(show),
                bbox_inches='tight', dpi=600)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV2-reorderV2-sensitivity.pdf'.format(show),
                bbox_inches='tight', transparent=True)
...
def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_sensitivity(show='full'):
    indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    output_dir = indir + r'figure_2cohorts/'
    df_1 = pd.read_csv(indir + 'causal_effects_specific.csv')
    df_1.drop_duplicates(subset=['pasc'], keep='last', inplace=True, )
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV4-sensitivity.png'.format(show), bbox_inches='tight',
                dpi=600)
    plt.savefig(output_dir + 'hr_moretabs-{}-updatedResultsV4-sensitivity.pdf'.format(show), bbox_inches='tight',
                transparent=True)
...
def plot_forest_for_preg_subgroup_lib2_cifdiff_with_N3C(show='full', outcome='any_pasc'):
    ...
    df2 = pd.read_excel(r'../data/recover/output/pregnancy_output/N3C/24_08_05 Updated Site N3C Results.xlsx')
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_subgroup-withN3C-{}-{}-namerevise-V2.png'.format(show, outcome), bbox_inches='tight',
                dpi=600)
    plt.savefig(output_dir + 'hr_subgroup-withN3C-{}-{}-namerevise-V2.pdf'.format(show, outcome), bbox_inches='tight',
                transparent=True)
...
#
# def plot_forest_for_preg_subgroup_lib2_cifdiff_with_N3C_v2(show='full', outcome='any_pasc'):
#     subgroup_list = [
#         'all',
#         'white', 'black',
#         'less35', 'above35',
...
#     output_dir = r'../data/recover/output/pregnancy_output/figure_subgroup/'
#
#     df2 = pd.read_excel(r'../data/recover/output/pregnancy_output/N3C/24_07_21 Publication N3C Results-trans-edit.xlsx')
#     df2 = df2.set_index('Unnamed: 0')
#     # df2 = df2.transpose()
#
#     results_list = []
...
#         # group_order=df_result['group'].unique(),
#         xlabel="Hazard Ratio",  # x-label title
#         xticks=[0.01, 1, 1.5] if outcome == 'PASC-General' else [0.1, 1, 1.5], #[0.35, 1, 1.5],  # x-ticks to be printed
#         color_alt_rows=True,
#         # flush=True,
#         # sort=True,  # sort estimates in ascending order
#         # sortby='-aHR',
...
#     axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
#     check_and_mkdir(output_dir)
#     plt.savefig(output_dir + 'hr_subgroup-withN3C-V2-{}-{}.png'.format(show, outcome), bbox_inches='tight', dpi=600)
#     plt.savefig(output_dir + 'hr_subgroup-withN3C-V2-{}-{}.pdf'.format(show, outcome), bbox_inches='tight',
#                 transparent=True)
#
#     print('Done')
#     return df_result
...
def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly(indir, show='full'):
    # # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-nopaxremd/'
    # # 2024-11-15, in addition to checking lab-dx only cohort, also reuse for other sensitivity analyses
    # # Warning: need to revise 'Any PASC': 'PCORNet-Lab/Dx',  --> to other labels
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-all-NoEdema/'
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-base2visit/'
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-base2visitand1follow/'
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k5useacute1-V3-base2visitand1follow/'
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k10useacute1-V3-base2visitand1follow/'
    print('indir', indir)

    output_dir = indir + r'figure_4revision/'
    df_1 = pd.read_csv(indir + 'causal_effects_specific.csv')
    df_1.drop_duplicates(subset=['pasc'], keep='last', inplace=True, )
    ...
    organ_mapname = {
        'Any PASC': 'PCORNet-Sensitivity',  # 'PCORNet-Lab/Dx',  #'PCORNet-Primary', #'Primary-PCORNet',
        'Death': 'Overall',
        'Hospitalization': 'Overall',
        'Diseases of the Nervous System': 'Neurologic',
        'Diseases of the Skin and Subcutaneous Tissue': 'Skin',
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_moretabs-{}-4revision.png'.format(show), bbox_inches='tight', dpi=600)
    plt.savefig(output_dir + 'hr_moretabs-{}-4revision.pdf'.format(show), bbox_inches='tight', transparent=True)

    print('Done')
    return df_result


def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly_furtherwithN3C(indir, show='full'):
    # # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-nopaxremd/'
    # # 2024-11-15, in addition to checking lab-dx only cohort, also reuse for other sensitivity analyses
    # # Warning: need to revise 'Any PASC': 'PCORNet-Lab/Dx',  --> to other labels
    ...
    axs.axvline(x=1, ymin=0, ymax=0.95, color='grey', linestyle='dashed')
    check_and_mkdir(output_dir)
    plt.savefig(output_dir + 'hr_moretabs-{}-4revision_furtherwithN3C.png'.format(show), bbox_inches='tight', dpi=600)
    plt.savefig(output_dir + 'hr_moretabs-{}-4revision_furtherwithN3C.pdf'.format(show), bbox_inches='tight', transparent=True)
...
if __name__ == '__main__':
    ...
    ## 2024/7/30 --> 8/6, n3c results update
    # primary results
    # plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3(show='full-nopval')
    # secondary results
    # plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_sensitivity(show='full-nopval')
    # end 2024/07/30 --> 8/6
    ...
    # revision 1 plot, 2024-11-12 to ***
    # plot results without pax/remd identified patients
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-nopaxremd/'
    #plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly(indir, show='full-nopval')
    # 2024-11-15. add indir as parameter, update label, more results
    # ## Warning: need to revise 'Any PASC': 'PCORNet-Lab/Dx',  --> to other labels
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-all-NoEdema/'
    # plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly(indir, show='full-nopval')
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3-base2visit/'
    ...
    # 2024-11-19, add N3C for comparison
    indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k5useacute1-V3-base2visitand1follow/'
    plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly_furtherwithN3C(indir, show='full-nopval')

    ## 2024-07-30 (not used, abando this v2 version)

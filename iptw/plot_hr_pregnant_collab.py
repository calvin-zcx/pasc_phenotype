...
def plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly(show='full'):
    # indir = r'../data/recover/output/pregnancy_output/POSpreg_vs_posnon-usedx1k3useacute1-V3/'
    ...
    organ_mapname = {
        'Any PASC': 'PCORNet-Lab/Dx',  #'PCORNet-Primary', #'Primary-PCORNet',
        'Death': 'Overall',
        'Hospitalization': 'Overall',
        'Diseases of the Nervous System': 'Neurologic',
        'Diseases of the Skin and Subcutaneous Tissue': 'Skin',
...
if __name__ == '__main__':
    ...
    plot_forest_for_dx_organ_preg_lib2_with_N3C_updatedV3_4revision1_labdxonly(show='full-nopval')

...
if __name__ == "__main__":
    ...
    for i, pasc in tqdm(enumerate(drug_name_list, start=1), total=len(drug_name_list)):
        ...
        out_file_balance = r'../data/{}/output/character/outcome/MED-{}/{}-{}-results.csv'.format(args.dataset, args.severity, i, pasc)
        ...
        try:
            ...
            df_causal.to_csv(r'../data/{}/output/character/outcome/MED-{}/causal_effects_specific_med-ERRORSAVE.csv'.format(args.dataset, args.severity))

...
#python screen_ssri_iptw_pcornet.py  --exptype ssri-acute0-7  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-ssri-acute0-7.txt
#python screen_ssri_iptw_pcornet.py  --exptype snri-base-180-0  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-snri-base-180-0.txt

#python screen_ssri_iptw_pcornet.py  --exptype snri-base-180-0  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-snri-base-180-0.txt
#python screen_ssri_iptw_pcornet.py  --exptype snri-acute0-7  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-snri-acute0-7.txt
#python screen_ssri_iptw_pcornet.py  --exptype snri-acute0-15  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-snri-acute0-7.txt
...
#python screen_ssri_iptw_pcornet.py  --exptype ssriVSsnri-acute0-15  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-ssriVSsnri-acute0-15.txt

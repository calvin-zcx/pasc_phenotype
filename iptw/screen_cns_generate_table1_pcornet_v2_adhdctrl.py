...
def table1_less_4_print(exptype='all'):
    ...
    in_file = 'recover25Q2_covid_pos_addPaxFeats-addADHDctrl-withexposure.csv'
    ...
    if exptype == 'CNS-ADHD-acuteIncident-0-30':
        df1 = df.loc[((df['cnsldn-treat-0-30@adderall_combo'] >= 1) |
                      ...
                      (df['cnsldn-treat-0-30@dexmethylphenidate'] >= 1)) &
                     ((df['cnsldn-treat--1095-0@adderall_combo'] == 0) &
                      (df['cnsldn-treat--1095-0@lisdexamfetamine'] == 0) &
                      (df['cnsldn-treat--1095-0@methylphenidate'] == 0) &
                      (df['cnsldn-treat--1095-0@dexmethylphenidate'] == 0)), :]

        df0 = df.loc[((df['cnsldn-treat--1095-30@adderall_combo'] == 0) &
                      (df['cnsldn-treat--1095-30@lisdexamfetamine'] == 0) &
                      (df['cnsldn-treat--1095-30@methylphenidate'] == 0) &
                      (df['cnsldn-treat--1095-30@guanfacine'] == 0) &
                      (df['cnsldn-treat--1095-30@dexmethylphenidate'] == 0))
    ...
    elif exptype == 'CNS-ADHD-acuteIncident-activectrl-0-30':
        df1 = df.loc[((df['cnsldn-treat-0-30@adderall_combo'] >= 1) |
                      (df['cnsldn-treat-0-30@lisdexamfetamine'] >= 1) |
                      (df['cnsldn-treat-0-30@methylphenidate'] >= 1) |
                      (df['cnsldn-treat-0-30@dexmethylphenidate'] >= 1)) &
        ...
        df0 = df.loc[((df['adhdctrl-treat-0-30@viloxazine'] >= 1) |
                      (df['adhdctrl-treat-0-30@atomoxetine'] >= 1) |
                      (df['adhdctrl-treat-0-30@nortriptyline'] >= 1) |
                      (df['adhdctrl-treat-0-30@bupropion'] >= 1)
                      ) &
                     ((df['adhdctrl-treat--1095-0@viloxazine'] == 0) &
                      (df['adhdctrl-treat--1095-0@atomoxetine'] == 0) &
                      (df['adhdctrl-treat--1095-0@nortriptyline'] == 0) &
                      (df['adhdctrl-treat--1095-0@bupropion'] == 0)
                      ) &
                     ((df['cnsldn-treat--1095-30@adderall_combo'] == 0) &
                      (df['cnsldn-treat--1095-30@lisdexamfetamine'] == 0) &
                      (df['cnsldn-treat--1095-30@methylphenidate'] == 0) &
                      (df['cnsldn-treat--1095-30@dexmethylphenidate'] == 0)
                      ) &
        ...
        case_label = 'CNS-ADHD 0-30 Incident'
        ctrl_label = 'ADHD Active Ctrl 0-30 Incident'

    elif exptype == 'guanfacine-acuteIncident-0-30':
        df1 = df.loc[((df['cnsldn-treat-0-30@guanfacine'] >= 1)) &
                     ((df['cnsldn-treat--1095-0@guanfacine'] == 0)), :]

        df0 = df.loc[((df['cnsldn-treat-0-30@guanfacine'] >= 1)) &
                     ((df['cnsldn-treat--1095-30@adderall_combo'] == 0) &
                      (df['cnsldn-treat--1095-30@lisdexamfetamine'] == 0) &
                      (df['cnsldn-treat--1095-30@methylphenidate'] == 0) &
                      (df['cnsldn-treat--1095-30@dexmethylphenidate'] == 0) &
        ...
        case_label = 'guanfacine 0 to 30 Incident'
        ctrl_label = 'guanfacine 0 to 30 Incident w/o ADHD drugs -1095-30'

    elif exptype == 'adderall_combo-base-180-0':
    ...
    elif exptype == 'guanfacine-base-180-0':
    ...
    out_file = r'./cns_output/Table-cns-adhd-{}-25Q2-v3.xlsx'.format(exptype)
    out_file_df = r'./cns_output/Matrix-cns-adhd-{}-25Q2-v3.csv'.format(exptype)
    output_columns = ['All', case_label, ctrl_label, 'SMD']
    ...
    drug_col = ['cnsldn-treat-0-30@adderall_combo', 'cnsldn-treat-0-30@lisdexamfetamine',
                ...
                'adhdctrl-treat-0-30@viloxazine', 'adhdctrl-treat-0-30@atomoxetine',
                'adhdctrl-treat-0-30@nortriptyline', 'adhdctrl-treat-0-30@bupropion']
    ...
    records.append([])
    col_names = (
            ['dxcovCNSLDN-base@ADHD', 'ADHD_before_drug_onset', 'dxcovCNSLDN-base@Narcolepsy', 'dxcovCNSLDN-base@MECFS', 'dxcovCNSLDN-base@Pain',
    ...
    col_names_out = (['ADHD', 'ADHD_before_drug_onset', 'Narcolepsy', 'MECFS', 'Pain',
                      'alcohol opioid other substance'] + ['Cancer', 'Chronic kidney disease', 'Chronic liver disease',
...
if __name__ == '__main__':
    ...
    # 2025-05-07 add ADHD at exposure
    # df, df_out = table1_less_4_print(exptype='CNS-ADHD-acuteIncident-0-30')  # 'ssri-base180-acutevsnot'
    # guanfacine
    # df2, df_out2 = table1_less_4_print(exptype='guanfacine-acuteIncident-0-30')  # 'ssri-base180-acutevsnot'

    # table1_less_4_print(exptype='CNS-ADHD-postIncident-30-180')  # 'ssri-base180-acutevsnot'

    # 2025-5-21 ADHD ctrl
    df, df_out = table1_less_4_print(exptype='CNS-ADHD-acuteIncident-activectrl-0-30')  # 'ssri-base180-acutevsnot'

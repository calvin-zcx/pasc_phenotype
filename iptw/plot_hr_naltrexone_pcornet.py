...
def plot_forest_for_dx_organ_ssri_lib2_cifdiff_primary_v3(indir, drugname='Naltrexone', ctrlname='Non-naltrexone', show='full'):
...
if __name__ == '__main__':
    ...
    indir = r'../data/recover/output/results/naltrexone-matchK10replace-all-nal-inc0-30s100/'
    # indir = r'../data/recover/output/results/naltrexone-matchK5replace-all-nal-inc0-30s100/'

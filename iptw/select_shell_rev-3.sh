...
taskset --cpu-list 8-11 python screen_dx_vtrim_vac.py --dataset V15_COVID19 --site ALL --severity all 2>&1 | tee  log/screen_dx_insight_ALL_all_Vtrim_Vaccine.txt
taskset --cpu-list 8-11 python screen_dx_vtrim_vac.py --dataset oneflorida --site all --severity all 2>&1 | tee  log/screen_dx_oneflorida_all_all_Vtrim_Vaccine.txt

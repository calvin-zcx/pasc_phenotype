...
#python screen_ssri_iptw_pcornet.py  --exptype ssri-acute0-15  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-ssri-acute0-15.txt
#python screen_ssri_iptw_pcornet.py  --exptype ssri-base-120-0  2>&1 | tee  log_ssri/screen_ssri_iptw_pcornet-ssri-base-120-0.txt

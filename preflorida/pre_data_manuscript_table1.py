...
def table1_cohorts_characterization_analyse_V3(cohorts='covid_4manuNegNoCovidV2', dataset='all'):
    ...
    in_file = r'../data/oneflorida/output/character/matrix_cohorts_{}_bool_{}.csv'.format(
        cohorts, dataset)
    out_file = r'../data/oneflorida/output/character/table1_of_matrix_cohorts_{}_bool_{}_4table1-V3.xlsx'.format(
        cohorts, dataset)
...
if __name__ == '__main__':
    ...
    # df_table1, df_data = table1_cohorts_characterization_analyse_V2(cohorts='covid_4manuNegNoCovidV2', dataset='all')

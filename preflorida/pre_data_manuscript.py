...
def parse_args():
    ...
    args.output_med_info = r'../data/oneflorida/output/character/info_medication_cohorts_{}_{}-V2.csv'.format(
        args.cohorts,
        args.dataset)

    args.output_dx_info = r'../data/oneflorida/output/character/info_dx_cohorts_{}_{}-V2.csv'.format(
        args.cohorts,
        args.dataset)
                    ...
                    if rx in rxnorm_ing:
                        ...
                        for _rxfromndc in _rxset:
                            if _rxfromndc in rxnorm_ing:
                                ...
                                _rxingset.update(_added)
                        if _rxingset:
                            _med_set_base.update(_rxingset)
                        else:
...
def rwd_dx_and_pasc_comparison():
    ...
    df_icd = pd.read_csv(r'../data/oneflorida/output/character/info_dx_cohorts_covid_4manuNegNoCovidV2_all-V2.csv',
    ...
    df.to_csv(r'../data/oneflorida/output/character/info_dx_cohorts_covid_4manuNegNoCovidV2_all_with_PASC-V2.csv',
              index=False)
    ...
    df_pasc_withrwd.to_csv(
        r'../data/oneflorida/output/character/PASC_Adult_Combined_List_with_covid_4manuNegNoCovidV2.csv',
        index=False)

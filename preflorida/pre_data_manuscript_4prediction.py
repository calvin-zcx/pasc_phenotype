...
if __name__ == '__main__':
    # python pre_data_manuscript_4prediction.py --dataset all --cohorts covid_4manuNegNoCovid 2>&1 | tee  log/pre_data_manuscript_4prediction_covid_4manuNegNoCovid_all1-10partsV2.txt

...
def parse_args():
    ...
    args.input_file = r'../data/oneflorida/{}/DIAGNOSIS.csv'.format(args.dataset)
    args.patient_list_file = r'../data/oneflorida/output/{}/patient_covid_lab_{}.pkl'.format(args.dataset, args.dataset)
    args.output_file = r'../data/oneflorida/output/{}/diagnosis_{}.pkl'.format(args.dataset, args.dataset)
    print('args:', args)
    return args

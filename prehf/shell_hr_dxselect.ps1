...
#python pre_cohort_hf.py --dataset wcm 2>&1 | tee  log/pre_cohort_hf_wcm.txt
python pre_data_manuscript_withAllDays_few.py --dataset wcm 2>&1 | tee  log\pre_data_manuscript_withAllDays_few_wcm.txt
...
#python pre_cohort_hf.py --dataset montefiore 2>&1 | tee  log/pre_cohort_hf_montefiore.txt
python pre_data_manuscript_withAllDays_few.py --dataset montefiore 2>&1 | tee  log\pre_data_manuscript_withAllDays_few_montefiore.txt
...
#python pre_cohort_hf.py --dataset mshs 2>&1 | tee  log/pre_cohort_hf_mshs.txt
python pre_data_manuscript_withAllDays_few.py --dataset mshs 2>&1 | tee  log\pre_data_manuscript_withAllDays_few_mshs.txt
...
#python pre_cohort_hf.py --dataset columbia 2>&1 | tee  log/pre_cohort_hf_columbia.txt
python pre_data_manuscript_withAllDays_few.py --dataset columbia 2>&1 | tee  log\pre_data_manuscript_withAllDays_few_columbia.txt

...
def parse_args():
    ...
    args.input_file = r'../data/V15_COVID19/{}/immunization.sas7bdat'.format(args.dataset)
    args.patient_list_file = r'../data/V15_COVID19/output/{}/patient_covid_lab_{}.pkl'.format(args.dataset, args.dataset)
    args.output_file = r'../data/V15_COVID19/output/{}/immunization_{}.pkl'.format(args.dataset, args.dataset)

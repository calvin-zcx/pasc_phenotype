...
def parse_args():
    ...
    parser.add_argument('--cohorts', choices=['pasc_incidence', 'pasc_prevalence', 'covid',
                                              ...
                                              'covid_anyDx'],
                        default='covid_anyDx', help='cohorts')
...
def build_query_1and2_matrix(args):
    ...
    for site in tqdm(sites):
        ...
        id_data = utils.load(input_file, chunk=8)
...
if __name__ == '__main__':
    # python pre_data_manuscript_4replicateAnyQuery.py --dataset ALL --cohorts covid_anyDx 2>&1 | tee  log/pre_data_manuscript_4replicateAnyQuery.txt

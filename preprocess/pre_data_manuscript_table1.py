...
def table1_cohorts_characterization_analyse_V2(cohorts='covid_4manuNegNoCovidV2', dataset='ALL'):
    # severity in 'hospitalized', 'ventilation', None
    in_file = r'../data/V15_COVID19/output/character/matrix_cohorts_{}_bool_{}.csv'.format(
        cohorts, dataset)
    out_file = r'../data/V15_COVID19/output/character/table1_of_matrix_cohorts_{}_bool_{}_4table1-V2.xlsx'.format(
        cohorts, dataset)
    ...
    row_names.extend(col_names_out)
    records.extend(
        [[_quantile_str(df_pos[c]), _quantile_str(df_neg[c]), _smd(df_pos[c], df_neg[c])] for c in col_names])
...
def table1_cohorts_characterization_analyse_V3(cohorts='covid_4manuNegNoCovidV2', dataset='ALL'):
    # severity in 'hospitalized', 'ventilation', None
    in_file = r'../data/V15_COVID19/output/character/matrix_cohorts_{}_bool_{}.csv'.format(
        cohorts, dataset)
    out_file = r'../data/V15_COVID19/output/character/table1_of_matrix_cohorts_{}_bool_{}_4table1-V3.xlsx'.format(
        cohorts, dataset)
...
if __name__ == '__main__':
    ...
    df_table1, df_data = table1_cohorts_characterization_analyse_V3(cohorts='covid_4manuNegNoCovidV2', dataset='ALL')

...
def parse_args():
    ...
    args.output_file_covid = r'../data/V15_COVID19/output/{}/cohorts_covid_{}.pkl'.format(args.dataset, args.dataset)
...
def integrate_data_and_apply_eligibility(args):
    ...
    # __step 4: save data structure for later encoding. save last cohort

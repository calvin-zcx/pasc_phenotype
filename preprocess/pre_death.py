...
def parse_args():
    ...
    args.input_file = r'../data/V15_COVID19/{}/death.sas7bdat'.format(args.dataset)
    args.output_file = r'../data/V15_COVID19/output/{}/death_{}.pkl'.format(args.dataset, args.dataset)

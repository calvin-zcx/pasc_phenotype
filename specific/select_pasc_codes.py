...
if __name__ == "__main__":
    ...
    df_code = pd.read_excel(r'preg_output/Supplementary Data 2-PASC_Adult_Diagnostic_List_for_Screen.xlsx',
                            sheet_name='PASC Screening List')
    df_pasc = df_pasc_info.loc[df_pasc_info['selected_narrow'] == 1, ['pasc', 'PASC Name Simple', 'Organ Domain']]


    df_merge = pd.merge(df_code, df_pasc, how='left', left_on='CCSR CATEGORY 1 DESCRIPTION', right_on='pasc')
    df_merge.to_excel(r'preg_output/Supplementary-PASC_Adult_Diagnostic_List_Selected.xlsx')

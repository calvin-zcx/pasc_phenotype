...
def screen_all_pasc(args, df, df_pasc_info, selected_pasc_list, dump=True):
    ...
    # selected_pasc_list = ['PASC-General', ] + selected_pasc_list
    print('selected_pasc_list: ', selected_pasc_list)

    # debug
    selected_pasc_list = ['PASC-General', ]
    print('selected_pasc_list: ', selected_pasc_list)
    ...
    # source_data = df.loc[:, ['flag@PASC-General', 'dx-t2e@PASC-General', 'age', 'adi', 'bmi', 'Female', 'Male', ] + covs_columns]
    # source_data.to_csv('U099_survival.csv', index=False)

python screen_risk_factors.py --dataset Pooled --goal anypascsevere --population positive --severity all 2>&1 | tee  log/screen_risk_factors-Pooled-elix-anypascsevere-positive-all-May17.txt
...
python screen_risk_factors.py --dataset Pooled --goal anypascmoderate --population positive --severity all 2>&1 | tee  log/screen_risk_factors-Pooled-elix-anypascmoderate-positive-all-May17.txt
python screen_risk_factors.py --dataset Pooled --goal anypascsevere --population positive --severity outpatient 2>&1 | tee  log/screen_risk_factors-Pooled-elix-anypascsevere-positive-outpatient-May17.txt
python screen_risk_factors.py --dataset Pooled --goal anypascmoderate --population positive --severity outpatient 2>&1 | tee  log/screen_risk_factors-Pooled-elix-anypascmoderate-positive-outpatient-May17.txt
python screen_risk_factors.py --dataset Pooled --goal anypascsevere --population positive --severity inpatienticu 2>&1 | tee  log/screen_risk_factors-Pooled-elix-anypascsevere-positive-inpatienticu-May17.txt
python screen_risk_factors.py --dataset Pooled --goal anypascmoderate --population positive --severity inpatienticu 2>&1 | tee  log/screen_risk_factors-Pooled-elix-anypascmoderate-positive-inpatienticu-May17.txt
...
python screen_risk_factors.py --dataset Pooled --goal allpasc --population positive --severity outpatient 2>&1 | tee  log/screen_risk_factors-Pooled-elix-allpasc-positive-outpatient-May17.txt
python screen_risk_factors.py --dataset Pooled --goal allpasc --population positive --severity inpatienticu 2>&1 | tee  log/screen_risk_factors-Pooled-elix-allpasc-positive-inpatienticu-May17.txt

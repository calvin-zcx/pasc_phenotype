...
def build_feature_matrix(args):
    ...
    # 1. Load target file
    # Load pregnant cohort, pregnant onset >= infection date = 30
    # Goal:
    # to update covs at pregnancy onset
    # to update outcomes with corresponding windows
    # with potentially newly added covs or outcomes

    infile_name = r'../data/recover/output/pregnancy_output_y4/pregnant_yr4_pergnantOnsetGEinfect30days.csv'
    ...
    for index, row in tqdm(df_cohort.iterrows(), total=len(df_cohort)):
        ...
        index_date_pregnant_onset = row['flag_pregnancy_start_date']
        ...
        if item:
            ...
            index_date_covid = index_date_covid.date()

...
def read_diagnosis(input_file, output_file='', selected_patients={}):
    ...
    print('Time range of diagnosis table of selected patients:', pd.to_datetime(dfs["ADMIT_DATE"]).describe(datetime_is_numeric=True))
    ...
    if output_file:
        ...
        utils.dump_compressed(id_dx, output_file) # use compreseed dump 2025 Q2

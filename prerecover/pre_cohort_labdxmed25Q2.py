...
def parse_args():
    ...
    args.covid_lab_file = r'../data/recover/output/{}/patient_covid_{}_{}.pkl.gz'.format(args.dataset,
                                                                                      args.cohorttype,
                                                                                      args.dataset)
    args.demo_file = r'../data/recover/output/{}/patient_demo_{}.pkl'.format(args.dataset, args.dataset)
    args.dx_file = r'../data/recover/output/{}/diagnosis_{}.pkl.gz'.format(args.dataset, args.dataset)
    args.med_file = r'../data/recover/output/{}/medication_{}.pkl.gz'.format(args.dataset, args.dataset)
    args.enc_file = r'../data/recover/output/{}/encounter_{}.pkl.gz'.format(args.dataset, args.dataset)
    # added 2022-02-02
    args.pro_file = r'../data/recover/output/{}/procedures_{}.pkl.gz'.format(args.dataset, args.dataset)
    ...
    # added 2023-11-8
    args.select_lab_file = r'../data/recover/output/{}/lab_result_select_{}.pkl.gz'.format(args.dataset, args.dataset)
    ...
    args.output_file_covid = r'../data/recover/output/{}/cohorts_covid_posneg18base_{}{}.pkl.gz'.format(
        args.dataset,
        args.dataset,
        '' if args.cohorttype == 'lab-dx-med' else '_' + args.cohorttype)
    args.output_file_covid2 = r'../data/recover/output/{}/cohorts_covid_posOnly18base_{}{}.pkl.gz'.format(
        args.dataset,
        args.dataset,
        '' if args.cohorttype == 'lab-dx-med' else '_' + args.cohorttype)
...
def integrate_data_and_apply_eligibility(args):
    ...
    utils.dump_compressed(data2, args.output_file_covid2)

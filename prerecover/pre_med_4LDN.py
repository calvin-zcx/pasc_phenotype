...
def parse_args():
    parser = argparse.ArgumentParser(description='preprocess medication table for extracting naltrexone')
    ...
    args.med_admin_output = r'../data/recover/output/{}/naltrexone_med_admin_{}.csv'.format(args.dataset, args.dataset)
    args.prescribe_output = r'../data/recover/output/{}/naltrexone_prescribing_{}.csv'.format(args.dataset, args.dataset)
    args.dispensing_output = r'../data/recover/output/{}/naltrexone_dispensing_{}.csv'.format(args.dataset, args.dataset)
...
if __name__ == '__main__':
    ...
    # step 1: load Naltrexone related drugs
    df_drug = pd.read_excel(r'../data/mapping/CNS_stimulants_and_Naltrexone_code_list_25April7.xlsx', sheet_name='naltrexone', dtype=str)
    code_set = set(df_drug['code'].to_list())
    print('Selected all Naltrexone related drug codes: ', df_drug, code_set)
    print('len(code_set):', len(code_set))
    print('args.dataset:', args.dataset)

    print("step 1. extract Naltrexone drug from prescribe")
    ...
    print("step 2. extract Naltrexone drug from med_admin")
    ...
    print("step 3. extract Naltrexone drug from dispensing")

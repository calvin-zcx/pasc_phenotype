...
def build_feature_matrix(args):
    ...
    for site in tqdm(sites):
        ...
        #
        output_file_query12_bool = r'../data/recover/output/{}/matrix_cohorts_{}-nbaseout-alldays-preg_{}-debug.csv'.format(
            args.dataset, args.cohorts, args.dataset)

        output_med_info = r'../data/recover/output/{}/info_medication_cohorts_{}_{}-debug.csv'.format(
            args.dataset, args.cohorts, args.dataset)

        output_dx_info = r'../data/recover/output/{}/info_dx_cohorts_{}_{}-debug.csv'.format(
            args.dataset, args.cohorts, args.dataset)
        ...
        # # add adi missing column, abandon this imputation, 2024/2/8
        ...
        for pid, item in tqdm(id_data.items(), total=len(id_data), mininterval=10):
            ...
            #
            social_array[i, :] = _encoding_social(nation_adi, impute_value=np.nan) # adi_value_default)

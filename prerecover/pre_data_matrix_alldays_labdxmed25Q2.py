...
def build_feature_matrix(args):
    ...
    for site in tqdm(sites):
        ...
        #
        output_file_query12_bool = r'../data/recover/output/{}/matrix_cohorts_{}-nbaseout-alldays-25Q2_{}.csv'.format(
        ...
        for pid, item in tqdm(id_data.items(), total=len(id_data), mininterval=10):
            ...
            outcome_covCNSLDN_flag[i, :], outcome_covCNSLDN_t2e[i, :], outcome_covCNSLDN_baseline[i,
                ...
                _encoding_outcome_dx_withalldaysoveralltime(dx, icd_covCNSLDN, covCNSLDN_encoding, index_date,
                                                            default_t2e)

...
def parse_args():
    ...
    parser.add_argument('--cohorttype', choices=['lab-dx-med-preg', 'lab-dx-med', 'lab-dx', 'lab'], default='lab-dx-med-preg')
    ...
    args.output_file_covid = r'../data/recover/output/{}/cohorts_covid_posnegpreg_{}{}.pkl.gz'.format(
        args.dataset,
        args.dataset,
